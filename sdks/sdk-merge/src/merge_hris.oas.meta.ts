...
export const oasMeta = {
  ...
  servers: [
    {url: 'https://api.merge.dev/api/hris/v1', description: 'Production'},
    {url: 'https://api-sandbox.merge.dev/api/hris/v1', description: 'Sandbox'},
    {url: 'https://api-eu.merge.dev/api/hris/v1', description: 'Production EU'},
    {
